...
public class ExceptionExam {
	...
	public static void main(String[] args) {
		...
		//catch 여러개 작성할때는 반드시 서브클래스 먼저 작성한다.
			...
			//e 를 출력하면 발생한 예외 클래스 이름 : 발생한 예외 메세지.
			...
			//개발할때는 사용하지만 배포(운영)모드에서 모두 제거 필수!
			e.printStackTrace();//개발자를 위한 메소드(예외정보를 detail하게 추적할 수 있다.)
		}finally {
			System.out.println("예외발생여부 상관없이 무조건 실행됩니다.");
		}

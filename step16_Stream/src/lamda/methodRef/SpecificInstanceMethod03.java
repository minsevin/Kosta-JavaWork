...
public class SpecificInstanceMethod03 { 
	...
	BiFunction<String, String, Boolean> beforeEquals3 = String :: equals;
	 ...
	 //3. 호출해보자
	System.out.println("결과 : " + beforeEquals.apply("jang","jang"));
	System.out.println("결과 : " + beforeEquals2.apply("jang","jang"));
	System.out.println("결과 : " + beforeEquals3.apply("jang","jang" ));
    } 
} 

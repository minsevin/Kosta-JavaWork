...
interface InterfaceExam00{//생성x, 상속x , implements  이용해서 사용한다.
...
public class ImplememtsInterfaceExam{ 
	public static void main(String args[]){		
		...
		InterfaceExam02 b       = new SubClassExam04();
		InterfaceExam00 c       = new SubClassExam04();
		SubClassExam04 d       = new SubClassExam04();
